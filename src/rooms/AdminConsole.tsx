  ...
  return (
    <div className="chat">
      ...
      <div className="chat-input-row">
        <input className="chat-input mono" type="text" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck={false} name="command" value={text} onChange={(e) => setText(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleSend()} placeholder="@help" />
